this.AdminDashboardAdminEventsAdminEditEventController = RouteController.extend({
    template: "AdminDashboard",
    yieldTemplates: {
	'AdminDashboardAdminEventsAdminEditEvent': { to: 'AdminDashboardSubcontent'}
	/*YIELD_TEMPLATES*/
    },
	...
	return [
	    ...
	    Meteor.subscribe("edit_event", this.params.eventId)
	];
	/*WAIT_FUNCTION*/
    },
    data: function() {
	return {
	    ...
	    edit_event: Events.findOne({_id:this.params.eventId}, {})
	};
	/*DATA_FUNCTION*/
    },
